...
const PostInteractions = ({
  ...
  count: { likes: number; rePosts: number; comments : number }, isLiked:boolean;
}) => {
  console.log("PostInteractions count:", count);
    return (
      <div className="flex items-center justify-between gap-4 lg:gap-16 my-2 text-textGray">
        <div className="flex items-center justify-between flex-1">
          ...
          <div className="flex items-center gap-2 cursor-pointer group">
            ...
            <span className="group-hover:text-iconGreen text-sm">{count.rePosts} </span>
          </div>
          {/* LIKE */}
          <div className="flex items-center gap-2 cursor-pointer group">
            <svg
            ...
            <span className={`${isLiked ? "text-iconPink" : "text-textGray"} group-hover:text-iconPink text-sm`} text-sm>{count.likes}</span>
          </div>
        </div>
